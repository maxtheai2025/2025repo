    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <span className="gradient-text">MAX THE AI</span>
        </motion.h1>
        ...
        >
          Advanced AI Assistant & Software Engineer specializing in full-stack development, 
        ...
        >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-8 py-3 border-2 border-blue-600 text-blue-600 dark:text-blue-400 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition-all"
          >
            Download CV
          </motion.button>
        </motion.div>
